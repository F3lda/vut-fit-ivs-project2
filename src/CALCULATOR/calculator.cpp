...
#define APP_TITLE       "Calculator - COGFIT1920" /**< Název okna */
#define APP_VERSION     "1.0" /**< Verze aplikace */
#define APP_NAME        "cz.vutbr.fit.ivs.calculator" /**< Název aplikace */
#define APP_ICON        "accessories-calculator" /**< Ikona programu */
#define APP_DOCUMENT    "https://github.com/F3lda/vut-fit-ivs-project2/blob/master/dokumentace.pdf" /**< Dokumentace programu */
#define APP_COPYRIGHT   "(c) GviDream" /**< Autorské právo */
#define APP_DESCRIPTION "A simple calculator created using GTK library for linux." /**< Popis aplikace */
#define APP_WEBSITE     "https://github.com/F3lda/vut-fit-ivs-project2/" /**< Webová stránka projektu */
#define APP_WEB_LABEL   "GitHub"
#define WINDOW_WIDGET   "mainWindow"
#define WINDOW_WIDTH    480 /**< Šířka okna */
#define WINDOW_HEIGHT   380 /**< Výška okna */
...
char RESULT[STR_BUFFER_SIZE] = ""; /**< Výsledek matematické operace */
